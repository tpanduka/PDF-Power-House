...
export const TextExtractor: React.FC = () => {
    ...
    const handleExtract = async () => {
        ...
        try {
            ...
            for (let i = 1; i <= numPages; i++) {
                ...
                setProgressMessage(`Extracting text from page ${i}...`);
                const textFromPage = await extractTextFromImage(base64Data, 'image/jpeg', language, promptHint);
                fullText += `--- Page ${i} ---\n${textFromPage}\n\n`;
                ...
                <>
                    ...
                    {file && !extractedText && (
                        <div className="mt-6">
                            ...
                            >
                                <ScanText className="mr-2" size={20} />
